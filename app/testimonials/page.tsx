  ...
  const testimonials = [
    {
      ...
      text: "CargoCore has been instrumental in streamlining our global supply chain. Their real-time tracking and reliable delivery have reduced our logistics costs by 20% while improving customer satisfaction.",
      rating: 5,
    },
    {
      name: "David Chen",
    ...
    },
    {
      ...
      text: "As an e-commerce company, reliable shipping is critical. CargoCore ensures our customers receive their orders quickly and safely. Their last-mile delivery service is second to none.",
      rating: 5,
    },
    {
      name: "James Thompson",
      ...
      text: "For sensitive pharmaceutical shipments, we need absolute reliability and compliance. CargoCore exceeds our expectations with their temperature-controlled options and meticulous documentation.",
      rating: 5,
    },
    {
      name: "Lisa Wong",
      ...
      text: "We ship hundreds of containers annually to diverse destinations. CargoCore simplifies the entire process with their intuitive platform and expert guidance through complex customs requirements.",
      rating: 5,
    },
    {
      ...
      text: "Perishable goods demand precision and care. CargoCore's commitment to quality handling and their advanced cooling solutions have made them our preferred logistics partner.",
      rating: 5,
    },
  ]
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Join thousands of satisfied customers who've transformed their logistics with CargoCore
            </p>
          </div>
      ...
      <section className="py-16 bg-accent/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Become part of the CargoCore family and experience the difference reliable logistics can make.
          </p>
